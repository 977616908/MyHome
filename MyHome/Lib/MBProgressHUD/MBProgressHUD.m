...
- (void)layoutSubviews {
	...
	CGSize labelSize = labelText.length>0 ? [label.text sizeWithFont:label.font]:CGSizeZero;
	...
	CGSize detailsLabelSize = detailsLabel.text.length>0 ? [detailsLabel.text sizeWithFont:detailsLabel.font
                                                                         constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode]:CGSizeZero;
