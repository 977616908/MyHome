...
//                                              context:nil].size;
    CGSize retSize=[self boundingRectWithSize:CGSizeMake(MAXFLOAT, label.font.lineHeight) withTextFont:label.font withLineSpacing:arc4random()%40 withTitle:label.text];
    return retSize.width;
}


-(CGSize)boundingRectWithSize:(CGSize)size withTextFont:(UIFont *)font withLineSpacing:(CGFloat)lineSpacing withTitle:(NSString *)title{
    NSMutableAttributedString *attributedText = [self attributedStringFromStingWithFont:font
                                                                        withLineSpacing:lineSpacing withTitle:title];
...
-(NSMutableAttributedString *)attributedStringFromStingWithFont:(UIFont *)font withLineSpacing:(CGFloat)lineSpacing withTitle:(NSString *)title

{
    NSMutableAttributedString *attributedStr = [[NSMutableAttributedString alloc] initWithString:title attributes:@{NSFontAttributeName:font}];
